...
$mail->Username = "direccionmedica@kaprimed.com"; 
$mail->Password = "direccionmedica2018"; 
//$mail->Username = "digipayargentina@gmail.com";  
//$mail->Password = "digipay2016"; 
$mail->Port = 465;  

$mail->From = "direccionmedica@kaprimed.com"; // Desde donde enviamos (Para mostrar)
$mail->FromName = "Web";

//Estas dos líneas, cumplirían la función de encabezado (En mail() usado de esta forma: “From: Nombre <correo@dominio.com>”) de //correo.
//$mail->AddAddress("nyndecoratuvida@gmail.com ");
//$mail->AddAddress("adrian.magliola@gmail.com");
$mail->AddAddress("direccionmedica@kaprimed.com");
$mail->IsHTML(true); // El correo se envía como HTML
$mail->Subject = "Kaprimed: Contacto WEB"; // Este es el titulo del email.
